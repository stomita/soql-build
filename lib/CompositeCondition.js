...
var CompositeCondition = function (_Condition) {
  ...
  function CompositeCondition(config, baseObjectName) {
    var stripParens = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];

    _classCallCheck(this, CompositeCondition);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CompositeCondition).call(this));
